	...
	public class MD5 : IDisposable
	{
		...
		public virtual byte[] Hash 
		{
			get
			{
				...
				// #if UNITY_FLASH replacement. AS compiler errors.
				//return (byte[])HashValue.Clone();
				return byteCopy(HashValue);
			}
		}
		...
		// #if UNITY_FLASH replacement. Creates a copy of a byte array. Clone() does not currently work 
		// in the compiled AS code.
		private byte[] byteCopy(byte[] inArray)
		{
