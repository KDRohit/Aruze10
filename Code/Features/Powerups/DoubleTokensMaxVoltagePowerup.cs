...
public class DoubleTokensMaxVoltagePowerup : PowerupBase
{
    protected override void init(JSON data = null)
    {
        base.init(data);
        rarity = Rarity.RARE;
        name = POWER_UP_DOUBLE_MAX_VOLTAGE_KEY;
        uiPrefabName = "PowerUp Icon MVZ Room Token Item";
        actionName = "play_now";
    }
    ...
    {
        base.doAction();
        LobbyInfo.Type targetLobby = LobbyInfo.Type.MAX_VOLTAGE;
