 ...
 * Creation Date: 3/14/2019
 */
public class Got01FreeSpins : IndependentReelFreeSpinGame 
{
	protected override void setDefaultReelStopOrder()
	{
		stopOrder = new StopInfo[][] 
		{
			...
			new StopInfo[] {new StopInfo(0,3,1),},
			...
			new StopInfo[] {new StopInfo(1,3,1),},
			...
			new StopInfo[] {new StopInfo(2,3,1),},
			...
			new StopInfo[] {new StopInfo(3,3,1),},
			...
			new StopInfo[] {new StopInfo(4,3,1),},
		};
	}
}
