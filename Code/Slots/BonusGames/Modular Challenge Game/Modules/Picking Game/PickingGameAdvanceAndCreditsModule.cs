...
/**
 * Module to handle revealing Advacne outcomes that also show credit values during a picking round
 */
public class PickingGameAdvanceAndCreditsModule : PickingGameAdvanceModule 
{
