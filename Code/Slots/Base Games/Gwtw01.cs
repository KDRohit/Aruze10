...
public class Gwtw01 : MultiSlotBaseGame 
{
	private const int NUMBER_OF_SYMBOLS_TO_CACHE_AT_ONCE = 25;
	private const int NUMBER_OF_TALL_SYMBOLS_TO_CACHE_AT_ONCE = 20;
	private string[] symbolsToCache = new string[]{"M1", "M2", "M3", "F4", "F5", "F6", "F7", "F8"};
	private string[] tallSymbolsToCache = new string[]{"M1-3A", "M2-3A", "M3-3A"};
