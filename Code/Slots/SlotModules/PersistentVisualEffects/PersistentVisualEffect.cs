...
public class PersistentVisualEffect : SlotModule
{
...
#region helper methods
	...
	private IEnumerator playActivationAnimationsForAnimationLevel(int myAnimationLevel, SlotSymbol triggerSymbol)
	{
		...
		if (visualEffectTierData != null && visualEffectTierData.isTierUsed == false && visualEffectAnimationData != null && visualEffectAnimationData.activate != null & visualEffectAnimationData.activate.Count > 0)
		{
