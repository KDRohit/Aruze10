...
*/
public class Moon01PickAndAddWildsToReelsModule : PickAndAddWildsToReelsModule 
{
	...
	[SerializeField] private string PICK_OBJ_PICKME_ANIM_NAME = "pickme";
	[SerializeField] private float BOX_PICKME_ANIM_LENGTH = 1.0f;
	[SerializeField] private string PICK_OBJ_STILL_ANIM_NAME = "still";
	[SerializeField] private string PICK_OBJ_REVEAL_ANIM_NAME = "reveal";
	[SerializeField] private string PICK_OBJ_REVEAL_GRAY_ANIM_NAME = "revealGray";

	[SerializeField] private string PICK_UI_INTRO_ANIM_NAME = "intro";
	[SerializeField] private string PICK_UI_OUTRO_ANIM_NAME = "outro";
	
	[SerializeField] private string COUNT_BOX_SLIDE_IN_ANIM_NAME = "intro";
	[SerializeField] private string COUNT_BOX_SLIDE_OUT_ANIM_NAME = "outro";

	// Sounds
	private const string FREE_SPIN_INTRO_MUSIC = "IntroFreespinMoonpies";
	private const string PICK_STAGE_MUSIC = "FreespinPickMoonpies";
	private const string SPIN_STAGE_MUSIC = "FreespinSpinMoonpies";

	private const string CURLY_FACE_WIPE_SOUND = "CurlyFaceWipe";
	private const float CURLY_FACE_WIPE_SOUND_DELAY = 0.5f;

	private const string SHOW_DIAMOND_PICK_UI_SOUND = "MoonPickOverlayRises";
	private const string HIDE_DIAMOND_PICK_UI_SOUND = "MoonPickOverlayDrops";
	
	private const string DIAMOND_WILDS_COUNTER_SOUND = "MoonSpinMoonpieRainMobile"; // needs to be looped then canceled when the counter is done

	private const string OBJECT_PICKME_ANIM_SOUND = "MoonPiePickMe";
	private const string OBJECT_REVEAL_SOUND = "PickAMoonPie";
	private const string OBJECT_REVEAL_LAST_SPIN_SOUND = "MoonPickRevealLastSpin";
	...
	private const string POST_PICK_VO = "RainingMoonpiesVO";

	private const string PICK_STAGE_START_VO = "FreespinIntroVOMoonpies";		// VO that plays every time you come back to the pick stage, assuming this means don't play it for the first time

	private const string DROP_EFFECT_LAND_SOUND = "ScatterWildLandsMoonpies";
