...
public class BuyCreditsProgressiveAction : ServerAction
{
	public const string GET_INFO = "get_buy_credits_progressive_jackpot_info";
	public const string RESET = "reset_buy_credits_progressive_jackpots";

	//property names

	public static void getInfo()
	{
		new BuyCreditsProgressiveAction(ActionPriority.IMMEDIATE, GET_INFO);
	}

	public static void reset()
	{
		new BuyCreditsProgressiveAction(ActionPriority.IMMEDIATE, RESET);
	}

	private BuyCreditsProgressiveAction(ActionPriority priority, string type) : base(priority, type)
	{
	}
