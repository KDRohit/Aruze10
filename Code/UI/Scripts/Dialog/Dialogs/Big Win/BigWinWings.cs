...
/**
Handles loading the texture for the wings on the big win effect.
*/

public class BigWinWings : TICoroutineMonoBehaviour
{
	...
	void Awake()
	{
		if (GameState.game != null)
		{
			...
			BonusGameWings.loadTextures(leftMeshFilter, rightMeshFilter, true);
		}
	}
