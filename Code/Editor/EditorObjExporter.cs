...
/**
Taken from: http://unifycommunity.com/wiki/index.php?title=ObjExporter
...
public class EditorObjExporter : ScriptableObject
{
    ...
    [MenuItem ("Zynga/Export/Export all MeshFilters in selection to separate OBJs")]
    ...
    [MenuItem ("Zynga/Export/Export whole selection to single OBJ")]
    static void ExportWholeSelectionToSingle()
    {
        ...
        if (exportedObjects > 0)
        {
         ...
         string filename = UnityEditor.SceneManagement.EditorSceneManager.GetActiveScene().path + "_" + exportedObjects;
    ...
    [MenuItem ("Zynga/Export/Export each selected to single OBJ")]
