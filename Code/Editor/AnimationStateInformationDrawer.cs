...
/**
 * Custom handling for AnimatorStateInformation that turns the animation state name into a drop down menu
 * and only reveals additional options once an animator is set.  Basically a version of AnimationListController.AnimationInformation
 * but with just bare bones data about the animation state (instead of control over how to play an animation).
 *
 * Original Author: Scott Lepthien
 * Creation Date: 4/7/2021
*/
[CustomPropertyDrawer (typeof (AnimatorStateInformation))]
public class AnimationStateInformationDrawer : PropertyDrawer 
{
