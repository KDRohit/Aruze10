...
public class MysteryGiftLobbyOptionDecorator1x2 : LobbyOptionDecorator
{
	public static GameObject overlayPrefab;

	private const string LOBBY_PREFAB_PATH = "Lobby Option Decorators/Mystery Gift Lobby Option Decorator 1x2";

	public static void loadPrefab(GameObject parentObject, LobbyOptionButtonGeneric option)
	{
		prepPrefabForLoading(overlayPrefab, parentObject, option, LOBBY_PREFAB_PATH, typeof(MysteryGiftLobbyOptionDecorator1x2));
	}
