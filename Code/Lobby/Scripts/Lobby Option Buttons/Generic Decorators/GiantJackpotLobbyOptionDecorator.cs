...
public class GiantJackpotLobbyOptionDecorator : LobbyOptionDecorator
{
	...
	{
		prepPrefabForLoading(overlayPrefab, parentObject, option, LOBBY_PREFAB_PATH, typeof(GiantJackpotLobbyOptionDecorator));
	}
