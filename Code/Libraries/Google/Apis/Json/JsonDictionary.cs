...
namespace Google.Apis.Json
{
    ...
    {
        /// <summary>
        /// Default (unsized) and sized dictionary constructors
        /// Prefer 'sized' construction to prevent re-allocations due to growth
        /// (These two constructors were added by Zynga to facilitate the JsonBinaryReader)
        /// </summary>
		public JsonDictionary() {}
        public JsonDictionary(int capacity) : base(capacity) {}
