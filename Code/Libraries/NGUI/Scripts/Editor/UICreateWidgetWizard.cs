...
public class UICreateWidgetWizard : EditorWindow
{
	...
	void CreateLabel (GameObject go)
	{
		...
		if (ShouldCreate(go, NGUISettings.font != null))
		{
			...
			///NGUI Warning Fix Start
			NGUIEditorTools.RegisterCreatedObjectUndo("Add Label (" + lbl.name + ")", lbl.gameObject);
			///NGUI Warning Fix End
	...
	void CreateSprite (GameObject go, string field)
	{
		...
		if (ShouldCreate(go, NGUISettings.atlas != null))
		{
			...
			///NGUI Warning Fix Start
			NGUIEditorTools.RegisterCreatedObjectUndo("Add Sprite (" + sprite.name + ")", sprite.gameObject);
			///NGUI Warning Fix End
	...
	void CreateSimpleTexture (GameObject go)
	{
		if (ShouldCreate(go, true))
		{
			...
			///NGUI Warning Fix Start
			NGUIEditorTools.RegisterCreatedObjectUndo("Add texture (" + tex.name + ")", tex.gameObject);
			///NGUI Warning Fix End
	...
	void CreateButton (GameObject go)
	{
		...
		if (ShouldCreate(go, NGUISettings.atlas != null))
		{
			...
			///NGUI Warning Fix Start
			NGUIEditorTools.RegisterCreatedObjectUndo("Create Button (" + go.name + ")", go);
			///NGUI Warning Fix End
	...
	void CreateImageButton (GameObject go)
	{
		...
		if (ShouldCreate(go, NGUISettings.atlas != null))
		{
			...
			///NGUI Warning Fix Start
			NGUIEditorTools.RegisterCreatedObjectUndo("Create Image Button (" + go.name + ")", go);
			///NGUI Warning Fix End
	...
	void CreateCheckbox (GameObject go)
	{
		...
		if (ShouldCreate(go, NGUISettings.atlas != null))
		{
			...
			///NGUI Warning Fix Start
			NGUIEditorTools.RegisterCreatedObjectUndo("Create Check Box (" + go.name + ")", go);
			///NGUI Warning Fix End
	...
	void CreateScrollBar (GameObject go)
	{
		...
		if (ShouldCreate(go, NGUISettings.atlas != null))
		{
			...
			///NGUI Warning Fix Start
			NGUIEditorTools.RegisterCreatedObjectUndo("Create Scroll Bar (" + go.name + ")", go);
			///NGUI Warning Fix End
			Selection.activeGameObject = go;
		}
	}
	...
	void CreateSlider (GameObject go, bool slider)
	{
		...
		if (ShouldCreate(go, NGUISettings.atlas != null))
		{
			...
			///NGUI Warning Fix Start
			NGUIEditorTools.RegisterCreatedObjectUndo("Create Slider (" + go.name + ")", go);
			///NGUI Warning Fix End
	...
	void CreateInput (GameObject go)
	{
		...
		if (ShouldCreate(go, NGUISettings.atlas != null && NGUISettings.font != null))
		{
			...
			///NGUI Warning Fix Start
			NGUIEditorTools.RegisterCreatedObjectUndo("Create Input (" + go.name + ")", go);
			///NGUI Warning Fix End
	...
	void CreatePopup (GameObject go, bool isDropDown)
	{
		...
		if (ShouldCreate(go, NGUISettings.atlas != null && NGUISettings.font != null))
		{
			...
			///NGUI Warning Fix Start
			NGUIEditorTools.RegisterCreatedObjectUndo("Create Popup (" + go.name + ")", go);
			///NGUI Warning Fix End
