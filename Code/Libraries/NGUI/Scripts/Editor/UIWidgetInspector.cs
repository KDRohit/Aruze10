...
public class UIWidgetInspector : TICoroutineMonoBehaviourEditor
{
	enum Action
	{
		None,
	...
	/// </summary>
	/// Added by Zynga - Mike Wood (Telos) - made virtual to allow for it to be overriden by label class.
