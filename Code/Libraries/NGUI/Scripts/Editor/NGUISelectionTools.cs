...
public class NGUISelectionTools
{
	...
	[MenuItem("GameObject/Selection/Toggle 'Active'")]
	...
	[MenuItem("GameObject/Selection/Add New Child")]
	static void CreateLocalGameObject ()
	{
		if (PrefabCheck())
		{
			...
			///NGUI Warning Fix Start
			NGUIEditorTools.RegisterCreatedObjectUndo("Add New Child", newGameObject);
			///NGUI Warning Fix End
